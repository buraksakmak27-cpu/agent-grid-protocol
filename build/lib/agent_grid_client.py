...
class AgentGrid:
    ...
    Args:
        base_url (str): Sunucu adresi. Varsayilan: http://127.0.0.1:8080
        timeout  (int): Istek zaman asimi (saniye). Varsayilan: 30
    """

    def __init__(self, base_url: str = "http://127.0.0.1:3000/v1", api_key: str = "ali_key_123", timeout: int = 30):
